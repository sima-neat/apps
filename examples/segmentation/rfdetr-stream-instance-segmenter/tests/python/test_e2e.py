"""E2E tests for rfdetr-stream-instance-segmenter (Python)."""
...
class TestE2E:
    def test_full_pipeline_rtsp_h264(
        ...
        output_cfg = e2e_config_section("rfdetr-stream-instance-segmenter", "testing.e2e.output")
        config_path = e2e_config_writer(
            {
                "source": {"url": rtsp_h264_url},
                "output": {
