// Unit test for faster-rcnn-object-detector: validates CLI arg handling.
...
int main(int argc, char** argv) {
  ...
  {
    ProcessResult r = spawn_and_wait(binary, {"--config", "/nonexistent/faster-rcnn-config.yaml"}, 20000);
    if (r.exit_code != 2) {
