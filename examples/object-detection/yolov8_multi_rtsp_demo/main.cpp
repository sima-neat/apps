...
struct Config {
  ...
  std::string labels_file = "examples/object-detection/yolov8_multi_rtsp_demo/coco_label.txt";
...
void usage() {
  std::cerr << "Usage:\n";
  std::cerr << "  yolov8_multi_rtsp_demo --model <mpk.tar.gz> --output <dir>\n";
  std::cerr << "    --rtsp <url0> [--rtsp <url1> ...]\n";
  std::cerr << "    [--labels-file examples/object-detection/yolov8_multi_rtsp_demo/coco_label.txt]\n";
