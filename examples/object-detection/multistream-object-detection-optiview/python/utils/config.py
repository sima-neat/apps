...
class AppConfig:
    ...
    optiview_host: str = ""
    optiview_video_port_base: int = 9000
    optiview_json_port_base: int = 9100
    optiview_json_offset_ms: float = 0.0
...
def load_app_config(path: str | Path) -> AppConfig:
    ...
    cfg = AppConfig(
        ...
        optiview_json_offset_ms=_optional_float(optiview, "json_offset_ms", 0.0),
