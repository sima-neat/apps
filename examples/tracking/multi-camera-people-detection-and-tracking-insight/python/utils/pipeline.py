...
def build_insight_video_run(
    ...
    sender_opt.udp.host = cfg.insight_host
    sender_opt.udp.port = insight_video_port_for_stream(cfg.insight_video_port_base, stream_index)
    sender_opt.udp.sync = False
    sender_opt.udp.async_ = False
