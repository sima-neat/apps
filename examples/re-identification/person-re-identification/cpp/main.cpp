/**
 * @example person-re-identification.cpp
 * Pairwise ReID pipeline: infer embeddings for two images and compare similarity.
 *
 * Usage: person-re-identification [--config <path>]
 */
#include "neat.h"
...
Config load_config(const fs::path& path) {
  ...
  cfg.output_dir = raw.string_or("io.output_dir", "sandbox/person-re-identification");
