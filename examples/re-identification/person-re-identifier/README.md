...
| Languages | C++, Python |
| Status | experimental |
| Binary Name | person-re-identifier |
| Model | reid |

## Preview
![Person re-identifier preview](../../../assets/portal/re-identification/person-re-identifier/image.png)
...
- Default output directory is `examples/re-identification/person-re-identifier/output_dir`.
...
### C++
- Invocation:
  `./build/examples/re-identification/person-re-identifier/person-re-identifier [--config <path>]`
- Optional arguments:
  `--config <path>`

### Python
- Invocation:
  `python3 examples/re-identification/person-re-identifier/python/main.py [--config <path>]`
- Optional arguments:
  `--config <path>`
...
Binary output:
```bash
./build/examples/re-identification/person-re-identifier/person-re-identifier
```

### Build This Example Directly With CMake
```bash
cd <apps-repo-root>
cmake -S examples/re-identification/person-re-identifier/cpp -B build/person-re-identifier
cmake --build build/person-re-identifier -j
```

Binary output:
```bash
./build/person-re-identifier/person-re-identifier
```
...
```bash
./build/examples/re-identification/person-re-identifier/person-re-identifier \
  --config examples/re-identification/person-re-identifier/common/config.yaml
```

### Python
```bash
source ~/pyneat/bin/activate
pip install -r examples/re-identification/person-re-identifier/python/requirements.txt
python3 examples/re-identification/person-re-identifier/python/main.py \
  --config examples/re-identification/person-re-identifier/common/config.yaml
```
