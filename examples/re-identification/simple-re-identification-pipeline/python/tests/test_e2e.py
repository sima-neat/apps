"""E2E tests for simple-re-identification-pipeline (Python)."""
...
class TestE2E:
    def test_full_pipeline(
        ...
        out_file = tmp_output_dir / "similarity.txt"
        assert out_file.exists(), "similarity.txt not written to output directory"
        assert out_file.stat().st_size > 0, "similarity.txt is empty"
