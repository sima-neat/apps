...
| Status | experimental |
| Binary Name | rtsp_depth_estimation |
...
### C++
```bash
./build/examples/depth-estimation/rtsp_depth_estimation/rtsp_depth_estimation \
...
cd apps
pip install -r examples/depth-estimation/rtsp_depth_estimation/requirements.txt
python3 examples/depth-estimation/rtsp_depth_estimation/main.py \
  --model models/midas_v21_small_256_mpk.tar.gz \
  --rtsp <rtsp_url> \
  --tcp \
  --frames <num_frames> \
