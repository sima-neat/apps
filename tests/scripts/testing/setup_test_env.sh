...
if [[ -n "${SIMANEAT_APPS_TEST_INSIGHT_VIDEO_PORT:-}" ]]; then
  echo "  SIMANEAT_APPS_TEST_INSIGHT_VIDEO_PORT=${SIMANEAT_APPS_TEST_INSIGHT_VIDEO_PORT}"
fi
if [[ -n "${SIMANEAT_APPS_TEST_INSIGHT_METADATA_PORT:-}" ]]; then
  echo "  SIMANEAT_APPS_TEST_INSIGHT_METADATA_PORT=${SIMANEAT_APPS_TEST_INSIGHT_METADATA_PORT}"
fi
